...
| PHP 8.3 | `seatonjiang/php` | `ghcr.io/seatonjiang/php` <br> `docker.cnb.cool/seatonjiang/monolith/php` | 8.3-fpm-alpine | 2026-05-08 |
| PHP 8.4 | `seatonjiang/php` | `ghcr.io/seatonjiang/php` <br> `docker.cnb.cool/seatonjiang/monolith/php` | 8.4-fpm-alpine | 2026-05-04 |
| PHP 8.5 | `seatonjiang/php` | `ghcr.io/seatonjiang/php` <br> `docker.cnb.cool/seatonjiang/monolith/php` | 8.5-fpm-alpine | 2026-05-08 |
...
| redis | `seatonjiang/redis` | `ghcr.io/seatonjiang/redis` <br> `docker.cnb.cool/seatonjiang/monolith/redis` | 8.6-alpine | 2026-05-08 |
