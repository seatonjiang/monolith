...
> 提示：云服务器需要在防火墙中放通 80、443 以及 phpMyAdmin 访问端口（默认为 28080），MariaDB 密码将随机生成。
...
| :--- | :--- | :--- | :--- | :--- |
| Caddy | `seatonjiang/caddy` | `docker.cnb.cool/seatonjiang/monolith/caddy` | alpine | 2026-09-14 |
| PHP | `seatonjiang/php` | `docker.cnb.cool/seatonjiang/monolith/php` | 8.5-fpm-alpine | 2026-09-14 |

### 同步的镜像

| 镜像名称 | 官方镜像 | 分发镜像 | 镜像标签 | 同步日期 |
| :--- | :--- | :--- | :--- | :--- |
| mariadb | `seatonjiang/mariadb` | `docker.cnb.cool/seatonjiang/monolith/mariadb` | 12.3 | 2026-09-19 |
| memcached | `seatonjiang/memcached` | `docker.cnb.cool/seatonjiang/monolith/memcached` | 1.6-alpine | 2026-09-20 |
| phpmyadmin | `seatonjiang/phpmyadmin` | `docker.cnb.cool/seatonjiang/monolith/phpmyadmin` | 5.2 | 2026-09-20 |
| redis | `seatonjiang/redis` | `docker.cnb.cool/seatonjiang/monolith/redis` | 8.10-alpine | 2026-09-22 |
