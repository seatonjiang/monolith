...
| PHP 8.3 | `seatonjiang/php` <br> `ghcr.io/seatonjiang/php` | 8.3-fpm-alpine | 2025-12-01 |
| PHP 8.4 | `seatonjiang/php` <br> `ghcr.io/seatonjiang/php` | 8.4-fpm-alpine | 2025-11-24 |
| PHP 8.5 | `seatonjiang/php` <br> `ghcr.io/seatonjiang/php` | 8.5-fpm-alpine | 2025-11-24 |
