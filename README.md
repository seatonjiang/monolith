...
| :--- | :--- | :--- | :--- | :--- |
| Caddy | `seatonjiang/caddy` | `docker.cnb.cool/seatonjiang/monolith/caddy` | alpine | 2026-08-24 |
| PHP | `seatonjiang/php` | `docker.cnb.cool/seatonjiang/monolith/php` | 8.5-fpm-alpine | 2026-08-24 |
