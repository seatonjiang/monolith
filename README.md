...
| 镜像名称 | 镜像地址 | 镜像标签 | 构建时间 |
| :--- | :--- | :--- | :--- |
| Caddy | `seatonjiang/caddy` <br> `ghcr.io/seatonjiang/caddy` | alpine | 2025-12-22 |
| PHP 8.3 | `seatonjiang/php` <br> `ghcr.io/seatonjiang/php` | 8.3-fpm-alpine | 2025-12-22 |
| PHP 8.4 | `seatonjiang/php` <br> `ghcr.io/seatonjiang/php` | 8.4-fpm-alpine | 2025-12-22 |
| PHP 8.5 | `seatonjiang/php` <br> `ghcr.io/seatonjiang/php` | 8.5-fpm-alpine | 2025-12-22 |
...
| phpmyadmin | `seatonjiang/phpmyadmin` <br> `ghcr.io/seatonjiang/phpmyadmin` | 5.2 | 2025-12-23 |
| redis | `seatonjiang/redis` <br> `ghcr.io/seatonjiang/redis` | 8.2-alpine,8.4-alpine | 2025-12-26 |
