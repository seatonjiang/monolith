...
| phpmyadmin | `seatonjiang/phpmyadmin` | `docker.cnb.cool/seatonjiang/monolith/phpmyadmin` | 5.2 | 2026-09-19 |
| redis | `seatonjiang/redis` | `docker.cnb.cool/seatonjiang/monolith/redis` | 8.10-alpine | 2026-09-19 |
