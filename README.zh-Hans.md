...
| 镜像名称 | 镜像链接 | 镜像标签 | 构建时间 |
| :--- | :--- | :--- | :--- |
| PHP 8.1 | `docker.cnb.cool/seatonjiang/monolith/php` | 8.1-fpm-alpine | 2025-09-15 |
| PHP 8.2 | `docker.cnb.cool/seatonjiang/monolith/php` | 8.2-fpm-alpine | 2025-09-15 |
| PHP 8.3 | `docker.cnb.cool/seatonjiang/monolith/php` | 8.3-fpm-alpine | 2025-09-16 |
| PHP 8.4 | `docker.cnb.cool/seatonjiang/monolith/php` | 8.4-fpm-alpine | 2025-09-15 |
| OpenResty | `docker.cnb.cool/seatonjiang/monolith/openresty` | alpine | 2025-09-16 |
...
| mariadb | `ghcr.io/seatonjiang/mariadb:12.0` | `ghcr.io/seatonjiang/mariadb:11.8`,12.0 | 2025-09-17 |
| Name | Registry | Tags |Sync Date |
| redis | `ghcr.io/seatonjiang/redis:7` | 7 | 2025-09-17 |
| redis | `ghcr.io/seatonjiang/redis:8` | 8 | 2025-09-17 |
## 📚 常见问题
